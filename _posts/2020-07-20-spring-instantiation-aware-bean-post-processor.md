...
![/assets/images/bean/spring-iiap-class.png](https://wiyi.org/assets/images/bean/spring-iiap-class.png){:.img-fallback}
...
![/assets/images/bean/bean-creation.jpg](https://wiyi.org/assets/images/bean/bean-creation.jpg){:.img-fallback}
<!--more-->

对于`InstantiationAwareBeanPostProcessor`而言，它的每个方法都会在Bean的创建周期被回调，我大概画了一下图

![/assets/images/bean/instantation.jpg](https://wiyi.org/assets/images/bean/instantation.jpg){:.img-fallback}
...
![/assets/images/bean/spring-create-instance.png](https://wiyi.org/assets/images/bean/spring-create-instance.png){:.img-fallback}
...
![/assets/images/bean/populate-1.png](https://wiyi.org/assets/images/bean/populate-1.png){:.img-fallback}

我们跟进populateBean方法，就能发现在这里会调用InstantiationAwareBeanPostProcessor的postProcessProperties方法。这里是重点，因为Bean的依赖注入是在这里完成的。

 ![/assets/images/bean/spring-bean-post-process.png](https://wiyi.org/assets/images/bean/spring-bean-post-process.png){:.img-fallback}
...
![/assets/images/bean/spring-annotation-utils.png](https://wiyi.org/assets/images/bean/spring-annotation-utils.png){:.img-fallback}
